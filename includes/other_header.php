                            ...
                            <div class="col-lg-6">
                                <div class="header-top_right">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="login-register.php">Register or Sign in</a>
                                        </li>
                                        <li>
                            ...
                            <div class="main-menu_area position-relative">
                                <nav class="main-nav d-flex justify-content-center">
                                    ...
                                    <li class="dropdown-holder"><a href="index.php">Home</a>
                                            ...
                                            <li><a href="blog-grid_view.php">Blog</a></li>
                                            <!-- <li><a href="blog-details.php">Blog Details</a></li> -->
                                            <li><a href="budget.php">Budget</a></li>
                                         
                                          
                                            <li><a href="javascript:void(0)">My Account <i class="ion-chevron-down"></i></a>
            ...
            <div class="offcanvas-minicart_wrapper" id="miniCart">
                <div class="offcanvas-menu-inner">
                    ...
                    <div class="minicart-content">
                        ...
                        <ul class="minicart-list">
                            ...
                            <li class="minicart-product">
                                ...
                                <div class="product-item_content">
                                    <a class="product-item_title" href="shop-left-sidebar.php">Tenetur illum
                                        amet</a>
                            ...
                            <li class="minicart-product">
                                ...
                                <div class="product-item_content">
                                    <a class="product-item_title" href="shop-left-sidebar.php">Non doloremque
                                        placeat</a>
                    ...
                    <div class="minicart-btn_area">
                        <a href="cart.php" class="kenne-btn kenne-btn_fullwidth">Minicart</a>
                    </div>
                    <div class="minicart-btn_area">
                        <a href="checkout.php" class="kenne-btn kenne-btn_fullwidth">Checkout</a>
                    </div>
                </div>
            </div>
                                ...
                                <li class="menu-item-has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="menu-item-has-children has-children">
                                            <a href="blog-grid_view.php">
                                                <span class="mm-text">Grid View</span>
                                            </a>
                                        </li>
                                        <li class="menu-item-has-children has-children">
                                            <a href="blog-list_view.php">
            ...
            <div class="offcanvas-menu_wrapper" id="offcanvasMenu">
                <div class="offcanvas-menu-inner">
                    ...
                    <div class="short-desc">
                        <p>We are a team of designers and developers that create high quality php Template &
                            Woocommerce,
                            Shopify Themes.
                        </p>
                    </div>
                    ...
                    <div class="offcanvas-component">
                        ...
                        <ul class="offcanvas-component_menu">
                            <li><a href="my-account.php">Register</a></li>
