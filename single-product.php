                        ...
                        <div class="col-lg-6">
                            <div class="sp-content">
                                <div class="sp-heading">
                                    <h5><a href="#"><?php echo $row->product_title ?></a></h5>
                                </div>
                                ...
                                <div class="qty-btn_area">
                                    <ul>
                                        <li><a class="qty-cart_btn" href="cart.php?id=<?php echo $row->product_id?>">Add To Cart</a></li>
                                        <li><a class="qty-wishlist_btn" href="wishlist.php" data-bs-toggle="tooltip" title="Add To Wishlist"><i class="ion-android-favorite-outline"></i></a>
                                        </li>
                        ...
                        "slidesToShow": 1
                            ...
                            <div class="product-item">
                                <div class="single-product">
                                    ...
                                    <div class="product-content">
                                        <div class="product-desc_info">
                                            <h3 class="product-name"><a href="single-product.php">Adipisci voluptas</a></h3>
                                            <div class="price-box">
                            ...
                            <div class="product-item">
                                <div class="single-product">
                                    ...
                                    <div class="product-content">
                                        <div class="product-desc_info">
                                            <h3 class="product-name"><a href="single-product.php">Possimus beatae</a></h3>
                                            <div class="price-box">
                            ...
                            <div class="product-item">
                                <div class="single-product">
                                    ...
                                    <div class="product-content">
                                        <div class="product-desc_info">
                                            <h3 class="product-name"><a href="single-product.php">Voluptates laudantium</a></h3>
                                            <div class="price-box">
                            ...
                            <div class="product-item">
                                <div class="single-product">
                                    ...
                                    <div class="product-content">
                                        <div class="product-desc_info">
                                            <h3 class="product-name"><a href="single-product.php">Eligendi voluptate</a></h3>
                                            <div class="price-box">
                            ...
                            <div class="product-item">
                                <div class="single-product">
                                    ...
                                    <div class="product-content">
                                        <div class="product-desc_info">
                                            <h3 class="product-name"><a href="single-product.php">Excepturi perspiciatis</a></h3>
                                            <div class="price-box">
                            ...
                            <div class="product-item">
                                <div class="single-product">
                                    ...
                                    <div class="product-content">
                                        <div class="product-desc_info">
                                            <h3 class="product-name"><a href="single-product.php">Esse eveniet</a></h3>
                                            <div class="price-box">
