            ...
            <ul class="nav navbar-right top-nav">
              ...
              <div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <li>
                    ...
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#demo"><i class="fa fa-fw fa-clipboard"></i> Posts <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="demo" class="collapse">
                            ...
                            <li>
                                <a href="post_categoies.php">Categories</a>
                            </li>
                            <li>
                                <a href="post_commment.php">Comments</a>
                            </li>
                        </ul>
                    </li>
                    <li>
